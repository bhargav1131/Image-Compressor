...
Label(text="\n\n\nDefine the quality in number.\nHigh value low compression, low value high compression: ", font=("arial", 12, "bold"), bg="black", fg="white").pack()
...
Button(master, text="COMPRESS", command=compress,bd=0, bg="#EFF2F0"). place(x=260, y=250)
